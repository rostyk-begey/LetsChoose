# Script to ignore vercel build if project is not affected by commit
# https://nx.dev/guides/deploy-nextjs-to-vercel#skipping-build-if-the-application-is-not-affected
