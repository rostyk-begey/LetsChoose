...
import { oneTapContainerId } from '../components/common/OneTapContainer';
...
const useGoogleSignInPrompt = ({ enabled }: UseGoogleSignInPromptProps) => {
...
export default useGoogleSignInPrompt;
