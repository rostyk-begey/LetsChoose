      ...
      <div className={classes.container}>
        ...
        <GridContainer>
          ...
          <GridItem xs={12} sm={12} md={6}>
            ...
            <Button
              onClick={(event: any) => setAnchorElLeft(event.currentTarget)}
            >
              On left
            </Button>
            <Popover
            ...
            <Button
              onClick={(event: any) => setAnchorElTop(event.currentTarget)}
            >
              On top
            </Button>
            <Popover
            ...
            <Button
              onClick={(event: any) => setAnchorElBottom(event.currentTarget)}
            >
              On bottom
            </Button>
            <Popover
            ...
            <Button
              onClick={(event: any) => setAnchorElRight(event.currentTarget)}
            >
              On right
            </Button>
            <Popover
